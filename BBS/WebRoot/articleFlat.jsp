...
<%
	...
	String sql = "select * from article where pid = 0 limit "+ begin + "," + pageSize ;
    ...
    <tbody>
      <tr valign="top">
        <td><span class="nobreak"> 页:
          <%=totalPages %> - <span class="jive-paginator"> [ <a href="articleFlat.jsp?pageNo=<%= pageNo-1 %>">上一页</a> | <a href="articleFlat.jsp?pageNo=1" class="">1</a> <a href="articleFlat.jsp?pageNo=2" class="jive-current">2</a> <a href="articleFlat.jsp?pageNo=3" class="">3</a>  | <a href="articleFlat.jsp?pageNo=<%= pageNo+1 %>">下一页</a> ] </span> </span></td>
      <td>
